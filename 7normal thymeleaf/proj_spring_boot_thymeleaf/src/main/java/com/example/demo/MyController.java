...
@RequestMapping(path = "/example") // URL's start with /example (after Application path) all methods default to
									// this
public class MyController {
	...
	// will always be called before any request handler method that returns the
	// "mainpage" view. including redirects
	@ModelAttribute
	public void loadPage(Model model) {
		...
		*/
		...
		model.addAttribute("myvariable", people); // <2>set a value for the thymeleaf variable "${myvariable}" in the
													// html.
